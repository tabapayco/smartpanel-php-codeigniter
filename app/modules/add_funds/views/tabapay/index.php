        ...
        <div class="row">
            <div class="col-md-12">
                <div class="for-group text-center">
                    <img src="/assets/images/payments/tabapay.png" alt="tabapay icon">
                    <p class="p-t-10"><small>شما می توانید با  تاباپی حساب خود را شارژ کنید این مبلغ به صورت خودکار به حساب شما اضافه می شود</small></p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <ul>
                        ...
                        <?php } ?>
                        <li><?=lang("Minimal_payment")?>: <strong><?php echo number_format($min_amount).' '.$currency_symbol; ?></strong></li>
                        <?php
                        if ($max_amount > 0) {
                            ?>
                            <li><?=lang("Maximal_payment")?>: <strong><?php echo number_format($max_amount).' '.$currency_symbol; ?></strong></li>
                        <?php } ?>
