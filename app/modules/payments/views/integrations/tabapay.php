                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="payment_params[option][environment]" class="form-control square">
                                            ...
                                            <option value="debug" <?php echo (isset($option->environment) && $option->environment == 'debug') ? 'selected' : ''; ?>><?php echo lang("debug"); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">مرچنت تاباپی<span class="form-required">*</span></label>
                                        <input type="text" class="form-control" name="payment_params[option][MerchantID]"
                                               value="<?php echo (isset($option->MerchantID)) ? $option->MerchantID : ''; ?>">
                                    </div>
                                </div>
